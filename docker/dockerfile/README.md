...
Since we are focusing on **Multi-Stage Dockerfiles**, there are 6 "Boss Commands" you need to master. If you understand these, you can containerize almost any application in the world.
...
**Can you try to write that out and tell me what happens when you run `docker build -t my-web-page .`? If you get an error, paste it here and we will fix it together!**
